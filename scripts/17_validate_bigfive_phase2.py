"""Validate v4 Big Five Phase 2 pilot readiness."""
...
from src.experiments.v4_bigfive_phase2_validation import (  # noqa: E402
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate v4 Big Five Phase 2.")
