...
`as_pas_only` isolates the no-prompt AS/PAS condition. Its bucket counts are {'both_positive': 0, 'bfi_only': 0, 'trait_only': 10, 'neither': 0}, with mean TRAIT movement +0.037 and mean BFI movement +0.000. Interpret this row as the direct test of whether AS also affects the BFI self-report surface.
...
`elaborate_prompt_as_pas` produces co-movement in most cells, but the movement sizes are uneven. The clearest decoupling is neuroticism-high, where BFI moves much more than TRAIT. Overall bucket counts are {'both_positive': 4, 'bfi_only': 0, 'trait_only': 6, 'neither': 0}, with mean BFI movement +0.127 and mean TRAIT movement +0.060.

| Trait | Target | Delta BFI target | BFI 95% CI | Delta TRAIT target | TRAIT 95% CI | Abs delta gap | Flag |
|---|---|---:|---|---:|---|---:|---|
| neuroticism | high | +0.344 | [+0.219, +0.438] | +0.058 | [+0.053, +0.065] | 0.285 | both_positive |
| agreeableness | high | +0.194 | [+0.083, +0.333] | +0.065 | [+0.058, +0.073] | 0.129 | both_positive |
| openness | low | +0.175 | [+0.100, +0.225] | +0.085 | [+0.076, +0.095] | 0.090 | both_positive |
| extraversion | low | +0.125 | [+0.031, +0.219] | +0.041 | [+0.034, +0.048] | 0.084 | both_positive |
| extraversion | high | +0.125 | [-0.062, +0.312] | +0.069 | [+0.060, +0.078] | 0.056 | trait_only |
| agreeableness | low | +0.111 | [-0.028, +0.250] | +0.066 | [+0.057, +0.075] | 0.045 | trait_only |
| conscientiousness | low | +0.028 | [-0.056, +0.111] | +0.071 | [+0.061, +0.079] | 0.043 | trait_only |
| neuroticism | low | +0.062 | [+0.000, +0.188] | +0.030 | [+0.026, +0.035] | 0.032 | trait_only |
| openness | high | +0.025 | [+0.000, +0.075] | +0.056 | [+0.049, +0.064] | 0.031 | trait_only |
| conscientiousness | high | +0.083 | [-0.111, +0.250] | +0.058 | [+0.052, +0.064] | 0.025 | trait_only |
