...
|---|---|---:|---:|---:|
| as_loglik | agreeableness | high | 150 | -0.040 |
| as_loglik | agreeableness | low | 150 | 0.016 |
| as_loglik | conscientiousness | high | 150 | -0.017 |
| as_loglik | conscientiousness | low | 150 | 0.002 |
| as_loglik | extraversion | high | 150 | 0.009 |
| as_loglik | extraversion | low | 150 | 0.037 |
| as_loglik | neuroticism | high | 150 | -0.030 |
| as_loglik | neuroticism | low | 150 | 0.017 |
| as_loglik | openness | high | 150 | 0.012 |
| as_loglik | openness | low | 150 | 0.112 |
| as_pas_final | agreeableness | high | 150 | -0.288 |
| as_pas_final | agreeableness | low | 150 | -0.427 |
| as_pas_final | conscientiousness | high | 150 | -0.288 |
| as_pas_final | conscientiousness | low | 150 | -0.480 |
| as_pas_final | extraversion | high | 150 | -0.204 |
| as_pas_final | extraversion | low | 150 | -0.418 |
| as_pas_final | neuroticism | high | 150 | -0.358 |
| as_pas_final | neuroticism | low | 150 | -0.389 |
| as_pas_final | openness | high | 150 | -0.133 |
| as_pas_final | openness | low | 150 | -0.327 |
| pas_final | agreeableness | high | 150 | -0.371 |
| pas_final | agreeableness | low | 150 | -0.480 |
| pas_final | conscientiousness | high | 150 | -0.343 |
| pas_final | conscientiousness | low | 150 | -0.508 |
| pas_final | extraversion | high | 150 | -0.235 |
| pas_final | extraversion | low | 150 | -0.478 |
| pas_final | neuroticism | high | 150 | -0.514 |
| pas_final | neuroticism | low | 150 | -0.389 |
| pas_final | openness | high | 150 | -0.157 |
| pas_final | openness | low | 150 | -0.498 |
| prompt_as_pas_final | agreeableness | high | 150 | -0.260 |
| prompt_as_pas_final | agreeableness | low | 150 | -0.453 |
| prompt_as_pas_final | conscientiousness | high | 150 | -0.206 |
| prompt_as_pas_final | conscientiousness | low | 150 | -0.425 |
| prompt_as_pas_final | extraversion | high | 150 | 0.074 |
| prompt_as_pas_final | extraversion | low | 150 | -0.358 |
| prompt_as_pas_final | neuroticism | high | 150 | -0.264 |
| prompt_as_pas_final | neuroticism | low | 150 | -0.358 |
| prompt_as_pas_final | openness | high | 150 | -0.157 |
| prompt_as_pas_final | openness | low | 150 | -0.400 |
| prompt_loglik | agreeableness | high | 150 | -0.130 |
| prompt_loglik | agreeableness | low | 150 | 0.037 |
| prompt_loglik | conscientiousness | high | 150 | -0.045 |
| prompt_loglik | conscientiousness | low | 150 | -0.025 |
| prompt_loglik | extraversion | high | 150 | -0.079 |
| prompt_loglik | extraversion | low | 150 | 0.082 |
| prompt_loglik | neuroticism | high | 150 | -0.212 |
| prompt_loglik | neuroticism | low | 150 | -0.042 |
| prompt_loglik | openness | high | 150 | 0.008 |
| prompt_loglik | openness | low | 150 | 0.113 |
