...
|---|---|---:|---:|---:|
| as_pas_only | agreeableness | high | 150 | 0.022 |
| as_pas_only | agreeableness | low | 150 | -0.030 |
| as_pas_only | conscientiousness | high | 150 | 0.023 |
| as_pas_only | conscientiousness | low | 150 | -0.024 |
| as_pas_only | extraversion | high | 150 | 0.041 |
| as_pas_only | extraversion | low | 150 | -0.025 |
| as_pas_only | neuroticism | high | 150 | -0.032 |
| as_pas_only | neuroticism | low | 150 | 0.017 |
| as_pas_only | openness | high | 150 | 0.037 |
| as_pas_only | openness | low | 150 | -0.057 |
| elaborate_prompt | agreeableness | high | 150 | -0.130 |
| elaborate_prompt | agreeableness | low | 150 | 0.037 |
| elaborate_prompt | conscientiousness | high | 150 | -0.045 |
| elaborate_prompt | conscientiousness | low | 150 | -0.025 |
| elaborate_prompt | extraversion | high | 150 | -0.079 |
| elaborate_prompt | extraversion | low | 150 | 0.082 |
| elaborate_prompt | neuroticism | high | 150 | -0.212 |
| elaborate_prompt | neuroticism | low | 150 | -0.042 |
| elaborate_prompt | openness | high | 150 | 0.008 |
| elaborate_prompt | openness | low | 150 | 0.113 |
| elaborate_prompt_as_pas | agreeableness | high | 150 | -0.117 |
| elaborate_prompt_as_pas | agreeableness | low | 150 | 0.033 |
| elaborate_prompt_as_pas | conscientiousness | high | 150 | -0.020 |
| elaborate_prompt_as_pas | conscientiousness | low | 150 | -0.036 |
| elaborate_prompt_as_pas | extraversion | high | 150 | -0.056 |
| elaborate_prompt_as_pas | extraversion | low | 150 | 0.080 |
| elaborate_prompt_as_pas | neuroticism | high | 150 | -0.197 |
| elaborate_prompt_as_pas | neuroticism | low | 150 | -0.024 |
| elaborate_prompt_as_pas | openness | high | 150 | 0.030 |
| elaborate_prompt_as_pas | openness | low | 150 | 0.090 |
| one_line_prompt | agreeableness | high | 150 | -0.108 |
| one_line_prompt | agreeableness | low | 150 | -0.279 |
| one_line_prompt | conscientiousness | high | 150 | -0.330 |
| one_line_prompt | conscientiousness | low | 150 | 0.021 |
| one_line_prompt | extraversion | high | 150 | -0.245 |
| one_line_prompt | extraversion | low | 150 | 0.104 |
| one_line_prompt | neuroticism | high | 150 | -0.441 |
| one_line_prompt | neuroticism | low | 150 | -0.073 |
| one_line_prompt | openness | high | 150 | -0.115 |
| one_line_prompt | openness | low | 150 | 0.127 |
