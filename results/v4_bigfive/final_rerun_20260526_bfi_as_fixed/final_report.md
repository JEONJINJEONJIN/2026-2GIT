...
|---|---|---:|---:|---:|---:|---:|
| as_pas_only | agreeableness | high | 150 | 0.887 | 0.139 | 0.029 |
| as_pas_only | agreeableness | low | 150 | 0.942 | 0.000 | 0.045 |
| as_pas_only | conscientiousness | high | 150 | 0.908 | 0.139 | 0.050 |
| as_pas_only | conscientiousness | low | 150 | 0.926 | -0.056 | 0.015 |
| as_pas_only | extraversion | high | 150 | 0.867 | 0.156 | 0.023 |
| as_pas_only | extraversion | low | 150 | 0.895 | -0.062 | 0.042 |
| as_pas_only | neuroticism | high | 150 | 0.922 | 0.094 | 0.018 |
| as_pas_only | neuroticism | low | 150 | 0.969 | 0.062 | 0.052 |
| as_pas_only | openness | high | 150 | 0.839 | 0.200 | 0.040 |
| as_pas_only | openness | low | 150 | 0.939 | 0.000 | 0.055 |
...
| elaborate_prompt_as_pas | agreeableness | high | 150 | 0.891 | 0.167 | 0.059 |
| elaborate_prompt_as_pas | agreeableness | low | 150 | 0.900 | -0.028 | 0.072 |
| elaborate_prompt_as_pas | conscientiousness | high | 150 | 0.852 | 0.222 | 0.074 |
| elaborate_prompt_as_pas | conscientiousness | low | 150 | 0.941 | 0.000 | 0.055 |
| elaborate_prompt_as_pas | extraversion | high | 150 | 0.614 | 0.438 | 0.052 |
| elaborate_prompt_as_pas | extraversion | low | 150 | 0.938 | 0.000 | 0.058 |
| elaborate_prompt_as_pas | neuroticism | high | 150 | 0.848 | 0.188 | 0.036 |
| elaborate_prompt_as_pas | neuroticism | low | 150 | 0.954 | 0.094 | 0.053 |
| elaborate_prompt_as_pas | openness | high | 150 | 0.881 | 0.175 | 0.059 |
| elaborate_prompt_as_pas | openness | low | 150 | 0.843 | -0.075 | 0.082 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| as_pas_only | agreeableness | high | -0.040 | [-0.046, -0.034] | +0.083 | +0.035 | [+0.030, +0.039] |
| as_pas_only | agreeableness | low | +0.016 | [+0.011, +0.020] | +0.056 | +0.038 | [+0.033, +0.044] |
| as_pas_only | conscientiousness | high | -0.017 | [-0.021, -0.013] | +0.056 | +0.034 | [+0.031, +0.038] |
| as_pas_only | conscientiousness | low | +0.002 | [-0.002, +0.005] | +0.028 | +0.031 | [+0.027, +0.035] |
| as_pas_only | extraversion | high | +0.009 | [+0.005, +0.013] | +0.031 | +0.041 | [+0.037, +0.045] |
| as_pas_only | extraversion | low | +0.037 | [+0.034, +0.041] | +0.062 | +0.025 | [+0.022, +0.028] |
| as_pas_only | neuroticism | high | -0.030 | [-0.040, -0.021] | +0.156 | +0.040 | [+0.037, +0.044] |
| as_pas_only | neuroticism | low | +0.017 | [+0.012, +0.022] | +0.000 | +0.029 | [+0.025, +0.033] |
| as_pas_only | openness | high | +0.012 | [+0.008, +0.016] | +0.025 | +0.038 | [+0.033, +0.042] |
| as_pas_only | openness | low | +0.112 | [+0.105, +0.118] | +0.175 | +0.058 | [+0.051, +0.065] |
...
| elaborate_prompt_as_pas | agreeableness | high | -0.036 | [-0.045, -0.027] | +0.111 | +0.065 | [+0.058, +0.073] |
| elaborate_prompt_as_pas | agreeableness | low | -0.027 | [-0.035, -0.020] | +0.028 | +0.066 | [+0.057, +0.076] |
| elaborate_prompt_as_pas | conscientiousness | high | -0.073 | [-0.079, -0.067] | +0.139 | +0.058 | [+0.053, +0.064] |
| elaborate_prompt_as_pas | conscientiousness | low | +0.016 | [+0.007, +0.024] | +0.083 | +0.071 | [+0.062, +0.081] |
| elaborate_prompt_as_pas | extraversion | high | -0.244 | [-0.252, -0.236] | +0.312 | +0.069 | [+0.060, +0.076] |
| elaborate_prompt_as_pas | extraversion | low | +0.080 | [+0.074, +0.086] | +0.125 | +0.041 | [+0.034, +0.047] |
| elaborate_prompt_as_pas | neuroticism | high | -0.104 | [-0.113, -0.094] | +0.250 | +0.058 | [+0.052, +0.065] |
| elaborate_prompt_as_pas | neuroticism | low | +0.002 | [-0.003, +0.007] | +0.031 | +0.030 | [+0.025, +0.035] |
| elaborate_prompt_as_pas | openness | high | +0.054 | [+0.046, +0.061] | +0.000 | +0.056 | [+0.049, +0.063] |
| elaborate_prompt_as_pas | openness | low | +0.016 | [+0.007, +0.025] | +0.100 | +0.085 | [+0.075, +0.095] |
...
|---|---|---:|---|---:|---:|---:|---:|
| as_pas_only | agreeableness | high | consistency | 150 | -0.040 | -0.046 | -0.034 |
| as_pas_only | agreeableness | low | consistency | 150 | 0.016 | 0.011 | 0.020 |
| as_pas_only | conscientiousness | high | consistency | 150 | -0.017 | -0.021 | -0.013 |
| as_pas_only | conscientiousness | low | consistency | 150 | 0.002 | -0.002 | 0.005 |
| as_pas_only | extraversion | high | consistency | 150 | 0.009 | 0.005 | 0.013 |
| as_pas_only | extraversion | low | consistency | 150 | 0.037 | 0.034 | 0.041 |
| as_pas_only | neuroticism | high | consistency | 150 | -0.030 | -0.040 | -0.021 |
| as_pas_only | neuroticism | low | consistency | 150 | 0.017 | 0.012 | 0.022 |
| as_pas_only | openness | high | consistency | 150 | 0.012 | 0.008 | 0.016 |
| as_pas_only | openness | low | consistency | 150 | 0.112 | 0.105 | 0.118 |
...
| elaborate_prompt_as_pas | agreeableness | high | consistency | 150 | -0.036 | -0.045 | -0.027 |
| elaborate_prompt_as_pas | agreeableness | low | consistency | 150 | -0.027 | -0.035 | -0.020 |
| elaborate_prompt_as_pas | conscientiousness | high | consistency | 150 | -0.073 | -0.079 | -0.067 |
| elaborate_prompt_as_pas | conscientiousness | low | consistency | 150 | 0.016 | 0.007 | 0.024 |
| elaborate_prompt_as_pas | extraversion | high | consistency | 150 | -0.244 | -0.252 | -0.236 |
| elaborate_prompt_as_pas | extraversion | low | consistency | 150 | 0.080 | 0.074 | 0.086 |
| elaborate_prompt_as_pas | neuroticism | high | consistency | 150 | -0.104 | -0.113 | -0.094 |
| elaborate_prompt_as_pas | neuroticism | low | consistency | 150 | 0.002 | -0.003 | 0.007 |
| elaborate_prompt_as_pas | openness | high | consistency | 150 | 0.054 | 0.046 | 0.061 |
| elaborate_prompt_as_pas | openness | low | consistency | 150 | 0.016 | 0.007 | 0.025 |
